...
if (path_principal == 'produto') {
    var _carrega_tabela_principal = function _carrega_tabela_principal() {
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                var indice = 0;
    ...
    var _carrega_tabela_principal2 = function _carrega_tabela_principal2() {
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                var indice = 0;
                var aux = this.responseText.replace('[{', '');
